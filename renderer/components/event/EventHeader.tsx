...
export function EventHeader(props: MatchesHeaderProps) {
  ...
  return (
    <div className="px-2 pt-4 overflow-visible w-full">
      {editing ? (
        ...
        <div className="flex flex-row w-full items-center justify-between">
          <div className="flex flex-col">
            ...
            <div className="mt-1 flex flex-col items-baseline sm:mt-0 sm:flex-row sm:flex-wrap sm:space-x-6">
              <div className="mt-2 flex items-baseline text-sm text-gray-300">
                <MapPinIcon
