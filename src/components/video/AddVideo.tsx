...
export default function AddVideo(props: AddVideoProps) {
  return (
    <button
      type="button"
      className="aspect-video w-full rounded-lg border-2 border-dashed border-gray-400 p-12 text-center hover:border-gray-300 focus:outline-none focus:ring-2 focus:ring-indigo-500 focus:ring-offset-2 group hover:bg-white/5 bg-white/0"
